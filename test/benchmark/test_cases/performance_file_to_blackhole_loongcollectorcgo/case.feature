...
Feature: performance file to blackhole LoongCollector-CGo
  ...
  @e2e-performance @docker-compose @loongcollector-cgo-blackhole
  Scenario: PerformanceFileToBlackholeLoongCollectorCGo
    ...
    When generate random nginx logs to file, speed {10}MB/s, total {5}min, to file {./test_cases/performance_file_to_blackhole_loongcollectorcgo/a.log}
