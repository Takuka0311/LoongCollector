...
Feature: performance file to blackhole iLogtail
  ...
  @e2e-performance @docker-compose @ilogtailC
  Scenario: PerformanceFileToBlackholeiLogtail
    ...
    When generate random nginx logs to file, speed {10}MB/s, total {10}min, to file {./test_cases/performance_file_to_blackhole_ilogtail/a.log}
